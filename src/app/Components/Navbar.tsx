      ...
      <Sheet>
        ...
        <SheetContent side="left">
          ...
          <div className="grid gap-2 py-6">
            ...
            <Link href="/texts" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
              TEXTS
            </Link>
            <Link href="/images" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
              IMAGES
            </Link>
